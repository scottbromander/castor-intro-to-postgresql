...
(102, 'Under the Bridge', 'Red Hot Chili Peppers', '1-29-1992');


SELECT * FROM "songs";
SELECT * FROM "songs" LIMIT 10;
SELECT "track" FROM "songs";
SELECT "track" FROM "songs" LIMIT 5;
SELECT "track", "artist" FROM "songs";
SELECT "track", "artist" FROM "songs" LIMIT 7;
SELECT * FROM "songs" WHERE "id"=101;
SELECT "track", "artist" FROM "songs" WHERE "track" LIKE '%all%';
SELECT "track", "artist" FROM "songs" WHERE "track" ILIKE '%all%';
SELECT "track", "artist" FROM "songs" WHERE "published" > '1/1/2000' LIMIT 5;
SELECT "track", "artist" FROM "songs" WHERE "published" > '1/1/2000' ORDER BY "artist" ASC LIMIT 5;
SELECT "track", "artist" FROM "songs" WHERE "published" > '1/1/2000' ORDER BY "artist" DESC LIMIT 5;
SELECT * FROM "songs" 
WHERE ("artist" LIKE '%a%' AND "published" > '1/1/2000') OR "id" > 150;
...
INSERT INTO "songs"("id", "rank", "artist", "track", "published") VALUES(101, 353, 'Nena', '99 Red Balloons', '1/1/1983') RETURNING "id", "rank", "artist", "track", "published";
